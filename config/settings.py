...
SECRET_KEY = "django-insecure-h+adleyi*((_!ip$*v#dp43_jm6kebxaput0bqetupf-%ueq=9"
...
DATABASES = {"default": config("DATABASE_URL", default=os.environ.get("DATABASE_URI"), cast=dburl)}
